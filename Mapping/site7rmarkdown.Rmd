...
legend <- 
  ggplot() +
  geom_point(data= LC_WQ7, aes(y= Salinity, x= newDate, fill= "Salinity"), color= "#999999") +
  geom_point(data= LC_WQ7, aes(x= newDate, y= Temperature, fill= "Temperature"), color= "#000000") +
...
ggdraw() +
  draw_plot(var7, x=0, y=0, width=.9, height=.9 ) +

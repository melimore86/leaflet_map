...
legend <- 
  ggplot() +
  geom_point(data= LC_WQ3, aes(y= Salinity, x= newDate, fill= "Salinity"), color= "#999999") +
  geom_point(data= LC_WQ3, aes(x= newDate, y= Temperature, fill= "Temperature"), color= "#000000") +
...
ggdraw() +
  draw_plot(var3, x=0, y=0, width=.9, height=.9 ) +

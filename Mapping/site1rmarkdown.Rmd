...
The main plot is continuous data gathered from a Diver sensor, which measures temperature, and conductivity hourly, since August 2017.     
...
phos1 <-
  ggplot(data= site1, aes(x= newDate, y=Phosphorus)) +
  ggtitle("Phosphorus") +
...
nitro1 <-
  ggplot(data= site1, aes(x= newDate, y=Nitrogen)) +
  ggtitle("Nitrogen") +
...
chloro1 <-
#windows()
  ggplot(data= site1, aes(x= newDate, y=Chlorophyll)) +
  ggtitle("Chlorophyll") +
...
secchi1 <-
  ggplot(data= site1, aes(x= newDate, y=Secchi)) +
  ggtitle("Secchi") +
...
color1 <-
#windows()
  ggplot(data= site1, aes(x= newDate, y=Color)) +
  ggtitle("Color") +
...
cond1 <-
  #windows()
  ggplot(data= site1, aes(x= newDate, y=allconduct)) +
...
ggdraw() +
    draw_plot(var1, x=0.2, y=0.45, width=0.60, height=0.40 ) +
    draw_plot(phos1, x=0, y=0.22, width=0.3, height=0.2 ) +
    draw_plot(nitro1, x=.33, y=0.22, width=0.3, height=0.2 ) +
    draw_plot(chloro1, x=0.67, y=0.22, width=0.3, height=0.2 ) +
    draw_plot(secchi1, x=0.33, y=0.0, width=0.3, height=0.2) +
    draw_plot(color1, x=0, y=0.0, width=0.3, height=0.2 ) +
    draw_plot(cond1, x=0.67, y=0.0, width=0.3, height=0.2 ) +

...
legend <- 
  ggplot() +
  geom_point(data= LC_WQ9, aes(y= Salinity, x= newDate, fill= "Salinity"), color= "#999999") +
  geom_point(data= LC_WQ9, aes(x= newDate, y= Temperature, fill= "Temperature"), color= "#000000") +
...
ggdraw() +
  draw_plot(var9, x=0, y=0, width=.9, height=.9 ) +
